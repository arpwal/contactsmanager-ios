...
[![Version](https://img.shields.io/badge/version-1.59.0-green.svg)](https://github.com/arpwal/contactsmanager-ios/releases)
...
```swift
dependencies: [
    .package(url: "https://github.com/arpwal/contactsmanager-ios.git", .exact("1.59.0"))
]
```
...
3. Select "Exact Version" and enter "1.59.0"
